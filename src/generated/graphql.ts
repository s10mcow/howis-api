...
> = ResolversObject<{
  createPost?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreatePostArgs, "location" | "photoURL" | "userId">
  >;
  createUser?: Resolver<
    Maybe<ResolversTypes["User"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateUserArgs, "auth0UserId" | "email" | "username">
  >;
  deletePost?: Resolver<
  ...
  >;
  updateUserHomeLocation?: Resolver<
    Maybe<ResolversTypes["User"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateUserHomeLocationArgs, "homeLocation" | "userId">
  >;
  updateUserProfileImage?: Resolver<
    ...
    ContextType,
    RequireFields<
      MutationUpdateUserProfileImageArgs,
      "profileImageURL" | "userId"
    >
  >;
  updateUserVerifiedStatus?: Resolver<
    Maybe<ResolversTypes["User"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateUserVerifiedStatusArgs, "id" | "verified">
  >;
  verifyUser?: Resolver<
    Maybe<ResolversTypes["User"]>,
    ParentType,
    ContextType,
    RequireFields<MutationVerifyUserArgs, "id">
  >;
}>;
...
> = ResolversObject<{
  ...
  >;
  getPostsNearLocation?: Resolver<
    Array<ResolversTypes["Post"]>,
    ParentType,
    ContextType,
    RequireFields<
      QueryGetPostsNearLocationArgs,
